    ...
    <div class="  col-12">
        <div class="d-flex flex-wrap col-12 mb-5">
            ...
            <div class="col-12  col-lg-6">
                <form action="/goods/add/cart" method="POST">
                    ...
                    <div class="mb-3">
                        <span>数量: </span>
                        <label class="w-25 ">
                            <input id="count" min="1" type="number" name="count" value="1"
                    ...
                    <div class="mt-5 d-flex flex-nowrap">
                        ...
                        <input type="submit" name="buy" value="立即购买"
                               class="col-6 col-lg-4 me-lg-2 btn btn-lg btn-outline-danger" id="buy">
                        ...
                        <input type="submit" style="display: none"
                               class="col-6 me-lg-2 col-lg-4 btn btn-lg btn-outline-danger" id="add">
                        ...
                        <div class="w-100">
                            <form method="POST" action="/goods/comment" id="comment-form">
                                ...
                                <div class="input-group">
                                    <textarea class="form-control" style="height: 64px" placeholder="快来评论一下商品吧"
                ...
                <ul class="list-group list-group-flush">
                    <%
                        ...
                        for (Comment comment : comments) {
                            User commentUser = Optional.ofNullable(userService.findOneById(comment.getUserId())).orElse(new User());
                            if (commentUser.getId() == 0) {
                                commentUser.setNickname("已注销");
                    ...
                    <li class="list-group-item p-4 d-flex  comment w-100">
                        <div>
                            <img src="<%=commentUser.getAvatar()%>" width="48" height="48" style="border-radius: 4px"
                                 alt="<%=commentUser.getNickname()%>">

                        </div>
                        <div class="ms-4 w-100">
                            <div class="font-primary ">
                                <%=commentUser.getNickname()%>
                                <span class="font-secondary ms-5"
                                      style="color:#b3b3b3;"> <%=DateFormatter.format(comment.getCreateTime())%></span>
                                <span class="font-secondary operate ">
                                        ...
                                        <a style="cursor: pointer"
                                           onclick="comment('<%=comment.getId()%>','<%=commentUser.getNickname()%>')">回复</a>
                                    </span>
                            </div>
                            <div class="font-secondary">
                                ...
                                <%=comment.getContent()%>
                                <% } else { %>
                                回复 @<%=userService.findOneById(parent.getUserId()).getNickname()%>
                                : <%=comment.getContent()%>
                                <% } %>
